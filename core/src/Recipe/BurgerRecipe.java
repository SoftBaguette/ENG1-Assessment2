...
public class BurgerRecipe extends Recipe{
    ...
    public BurgerRecipe(){
        ...
        ingredients.add(new Ingredient("Burger_bun", 1,0,0, AllTextures.getBurgerBunsTextures()));
        ingredients.add(new Ingredient("Meat",2,0,0, AllTextures.getPattyTextures()));
