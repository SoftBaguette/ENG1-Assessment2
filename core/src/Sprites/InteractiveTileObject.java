...
import static com.team13.piazzapanic.PlayScreen.stringsToStations;
...
public class InteractiveTileObject {
    ...
    public InteractiveTileObject(String name, World world, TiledMap map, BodyDef bdef, Rectangle rectangle, String type, boolean isPurchased, int price) {
        this.name = name;
        purchasable = true;
    ...
    public InteractiveTileObject(String name, String type) {
        this.name = name;
        this.type = type;
        ingredient = null;
        this.type = type;
    ...
    //    Added for testing purposes
    public Boolean getInteractingStatus() {
        return interacting;
    }
    ...
    public void writeName() {
        stringsToStations.put(this.name, this);
